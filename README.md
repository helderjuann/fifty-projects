...
Muitos desses projetos eu fiz seguindo a risca o pedido. Porém, com o conhecimento que adquiri durante esses meses, já consigo identificar e também sei como resolver alguns problemas que são apresentados nesses exercícios simples... Então em alguns dos 50 projetos, já adiantando que pode ter algumas mudanças em que eu fiz para melhorar a UI/UX do usuário. Ex. O exercício 6 não está fazendo a box aparecer dinamicamente utilizando "Append" por exemplo. Simplesmente está sendo utilizado um transform com o X(-400%) o que em uma página ou app web simplesmente não funcionaria da maneira correta.
